...
```bash
docker build -f docker/Dockerfile.serve -t netsentry-serve:0.6.0 .
# push to your registry, or load it into a local cluster:
kind load docker-image netsentry-serve:0.6.0   # kind
minikube image load netsentry-serve:0.6.0       # minikube
```
